...
_(Note: The live demo requires a compatible Chrome version and specific flags enabled. See [Setup for Gemini Nano](#setup-for-gemini-nano) below.)_
...
2. **Install dependencies:**
    ...
    _(If using npm: `npm install`)_
    _(If using yarn: `yarn install`)_
...
1. **Start the Vite development server:**
    ...
    _(If using npm: `npm run dev`)_
    _(If using yarn: `yarn dev`)_
...
1. **Build the application:**
    ...
    _(If using npm: `npm run build`)_
    _(If using yarn: `yarn build`)_
...
1. **Run ESLint:**
    ...
    _(If using npm: `npm run lint`)_
    _(If using yarn: `yarn lint`)_
...
1. **Preview the built application:**
    ...
    _(If using npm: `npm run preview`)_
    _(If using yarn: `yarn preview`)_
